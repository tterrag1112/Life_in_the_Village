...
| P1-04b | Civic placement migration | 04-town-square-rework | Deferred (prompt 18) | Polygon-edge `PLAZA_ADJACENT` slot emission; building-rotation override at `PlanContext.tryCommitBuilding` line 253 (within-8-blocks-of-polygon-edge → face centroid); removal of `LayoutPrimitive.TownSquare`'s ring-road + `civicRingRadius`. |
