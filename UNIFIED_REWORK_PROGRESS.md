...
| D3.3b | Phase 3 slice 2 — offices + capability gating | Not-Started | Depends D3.3a. Wires real office behaviour, competence scalar, KingdomCapability evaluator + GUI grey-out + server-side enforcement. |
