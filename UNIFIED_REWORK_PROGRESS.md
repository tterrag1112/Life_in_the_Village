...
| D3.4b | Phase 4 slice 2 — charters + intrigue + treaties (4.3+4.4+4.5) | Not-Started | Depends D3.4a. Six-charter catalogue (TOLL_RIGHTS / TAX_EXEMPTION / MARKET_MONOPOLY / TITLE_GRANT / ORDINATION_RIGHTS / LAND_GRANT). Spymaster intrigue (sow discontent / plot discovery / counter-intelligence). Four treaty types with cascade-break semantics. Per the user-confirmed precedence: treaties authoritative for cooperation; WAR/COLD_WAR residual; declaring WAR on an ally auto-breaks the ALLIANCE first. |
