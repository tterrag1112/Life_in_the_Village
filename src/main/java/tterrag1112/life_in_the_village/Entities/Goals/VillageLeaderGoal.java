...
public class VillageLeaderGoal extends Goal {
    ...
    private void meeting(ServerLevel level) {
        ...
        List<TownspersonMob> leaders = level.getEntitiesOfClass(
                ...
                mob -> mob != entity
                        && mob.getProfession() ==
                        TownspersonMob.Profession.VILLAGE_LEADER
        );
    ...
    private void assignProfessions(ServerLevel level,
        ...
        List<TownspersonMob> unemployed = level.getEntitiesOfClass(
                ...
                mob -> mob.getProfession() == TownspersonMob.Profession.NONE
                        && mob.isAdult()
        ...
        for (Building building : village.getBuildingIds().stream()
            ...
            TownspersonMob.Profession prof =
                    getProfessionForBuilding(building.getType());
            if (prof == TownspersonMob.Profession.NONE) continue;
    ...
    private TownspersonMob.Profession getProfessionForBuilding(
        ...
        return switch (type) {
            ...
            case MARKET          -> TownspersonMob.Profession.MERCHANT;
            ...
            default              -> TownspersonMob.Profession.NONE;
        };
    }
    ...
    private Building findTownHall(ServerLevel level, VillageSavedData data) {
        ...
        return village.getBuildingIds().stream()
                ...
                .filter(Optional::isPresent)
                .map(Optional::get)
                .filter(b -> b.getType() == Building.BuildingType.TOWN_HALL)
                .findFirst()
                .orElse(null);
    }
