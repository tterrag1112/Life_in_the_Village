...
public final class InternalRoadCommitter {
    ...
    /**
     * V2 variant of {@link #commit}. Builds the village-internal graph
     * directly from the {@link RoadNetwork} produced by V2 planning rather
     * than from a synthesized {@link VillageLayout}'s centerline list.
     *
